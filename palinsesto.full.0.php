...
<head>
    ...
    <style>
        ...
        .clip-start { background-color: rgb(255,255,255); top: 50px; left: 10px; position: absolute; width:26px; height:26px; }
        .clip-end { background-color: rgb(255,255,255); top: 50px; left: 300px; position: absolute; width:26px; height:26px; }
    </style>    
</head>
<body>
    ...
    <div id="main">
        ...
        <div class="content">
            ...
            <ul class="nav nav-tabs" role="tablist">
              <li class="active"><a href="#home" role="tab" data-toggle="tab">Programs</a></li>
              <li><a href="#profile" role="tab" data-toggle="tab">Composer</a></li>
              <li><a href="#messages" role="tab" data-toggle="tab">Track Composer</a></li>
            </ul>

            <!-- Tab panes -->
            <div class="tab-content">
                <div class="tab-pane active" id="home">
                    <?php @include("components/palinsesto_list.php"); ?>                                        
                </div>
